...
const uintptr_t __irq_vector_table _irq_vector_table[29] = {
...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[29] = {
	...
	{(const void *)0x80035be, (ISR)0x8000aed}, /* 5 */
	{(const void *)0x80035bc, (ISR)0x8000aed}, /* 6 */
	{(const void *)0x80035ba, (ISR)0x8000aed}, /* 7 */
	...
	{(const void *)0x800300c, (ISR)0x8002b3f}, /* 27 */
	{(const void *)0x8002ff0, (ISR)0x8002b3f}, /* 28 */
};
